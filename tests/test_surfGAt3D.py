...
def main():
    ...
    #plt.subplot(2, 1, 1)
    plt.semilogy(E_range+fermi_3d, dos_values_3d, 'b-', linewidth=2, label='surfGAt3D (k-space)')
    plt.semilogy(E_range+fermi_bethe, dos_values_bethe, 'r--', linewidth=2, label='surfGBAt (Bethe)')
