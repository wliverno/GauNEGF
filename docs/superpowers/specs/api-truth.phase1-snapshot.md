...
| surfGB | gauNEGF.surfG3D | class | (F, S, contacts, bar, latFile='Au', spin='r', eta=ETA, T=TEMPERATURE) | present | false |
| surfGB.__init__ | gauNEGF.surfG3D | method | (self, F, S, contacts, bar, latFile='Au', spin='r', eta=ETA, T=TEMPERATURE) | present | false |
| surfGB.genNeighbors | gauNEGF.surfG3D | method | (self, plane_normal, first_neighbor) | present | false |
| surfGB.readBetheParams | gauNEGF.surfG3D | method | (self, filename) | present | false |
| surfGB.constructMat | gauNEGF.surfG3D | method | (self, Mdict, dirCosines, SOC=False) | present | false |
| surfGB.sigma | gauNEGF.surfG3D | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGB.sigmaTot | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGB.crossTermQ | gauNEGF.surfG3D | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGB.crossTermQTot | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGB.getSigma | gauNEGF.surfG3D | method | (self, Elist=[None, None], conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGB.updateFermi | gauNEGF.surfG3D | method | (self, i, Ef) | present | false |
| surfGB.setF | gauNEGF.surfG3D | method | (self, F, muL, muR) | present | false |
| surfGB.testDOrbitalFunctions | gauNEGF.surfG3D | method | (self) | present | false |
| surfGB.testDOrbitalSymmetry | gauNEGF.surfG3D | method | (self) | present | false |
| surfGB.testPDInteraction | gauNEGF.surfG3D | method | (self) | present | false |
| surfGB.testDDInteraction | gauNEGF.surfG3D | method | (self) | present | false |
| surfGB.testHoppingPhysics | gauNEGF.surfG3D | method | (self) | present | false |
| surfGB.runAllTests | gauNEGF.surfG3D | method | (self) | present | false |
| surfGBAt | gauNEGF.surfG3D | class | (H, Slist, Vlist, eta, T=TEMPERATURE, SOC=False) | present | false |
| surfGBAt.__init__ | gauNEGF.surfG3D | method | (self, H, Slist, Vlist, eta, T=TEMPERATURE, SOC=False) | present | false |
| surfGBAt.updateH | gauNEGF.surfG3D | method | (self, fermi=None) | present | false |
| surfGBAt.sigmaK | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE, mix=0.5) | present | false |
| surfGBAt.sigmaSurf | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE, mix=0.5) | present | false |
| surfGBAt.crossTermQSurf | gauNEGF.surfG3D | method | (self, E, sigInds=None, conv=SURFACE_GREEN_CONVERGENCE, mix=0.5) | present | false |
| surfGBAt.crossTermQBulk | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE, mix=0.5) | present | false |
| surfGBAt.setF | gauNEGF.surfG3D | method | (self, F, mu1, mu2) | present | false |
| surfGBAt.sigmaTot | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGBAt.sigma | gauNEGF.surfG3D | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGBAt.crossTermQ | gauNEGF.surfG3D | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGBAt.crossTermQTot | gauNEGF.surfG3D | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGBAt.DOS | gauNEGF.surfG3D | method | (self, E) | present | false |
| surfGBAt.calcFermi | gauNEGF.surfG3D | method | (self, ne, tol=FERMI_CALCULATION_TOL) | present | false |
| surfGTest | gauNEGF.surfGBethe | class | (Fock, Overlap, indsList, sig1=None, sig2=None, spin='r') | present | false |
| surfGTest.__init__ | gauNEGF.surfGBethe | method | (self, Fock, Overlap, indsList, sig1=None, sig2=None, spin='r') | present | false |
| surfGTest.sigma | gauNEGF.surfGBethe | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGTest.sigmaTot | gauNEGF.surfGBethe | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGTest.setF | gauNEGF.surfGBethe | method | (self, F, mu1, mu2) | present | false |
| surfGTest.crossTermQ | gauNEGF.surfGBethe | method | (self, E, i, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
| surfGTest.crossTermQTot | gauNEGF.surfGBethe | method | (self, E, conv=SURFACE_GREEN_CONVERGENCE) | present | false |
...
| inv | gauNEGF.utils | function | (A) | absent | false |
| eig | gauNEGF.utils | function | (A) | absent | false |
| eigh | gauNEGF.utils | function | (A) | absent | false |
...
- **Total modules:** 14
- **Total classes:** 13 (1 deprecated)
- **Total functions:** 68 (1 deprecated module)
- **Total deprecated symbols:** 5 (DOSFermiSearch and its 4 methods)
- **Total absent docstrings:** 4 (calcEmin, inv, eig, eigh)

All modules contain module-level docstrings except surfG1D. The deprecated symbols are all in the fermiSearch module, which is marked as a whole for deprecation. Minimal docstring gaps exist in utility functions (inv, eig, eigh) and one integration limit calculation function (calcEmin).
